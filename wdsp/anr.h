...
extern __declspec (dllexport) void SetRXAANRVals (int channel, int taps, int delay, float gain, float leakage);
...
extern __declspec (dllexport) void SetRXAANRGain (int channel, float gain);

extern __declspec (dllexport) void SetRXAANRLeakage (int channel, float leakage);
