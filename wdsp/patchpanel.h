...
extern __declspec (dllexport) void SetRXAPanelGain1 (int channel, float gain);

extern __declspec (dllexport) void SetRXAPanelGain2 (int channel, float gainI, float gainQ);

extern __declspec (dllexport) void SetRXAPanelPan (int channel, float pan);
