...
extern __declspec (dllexport) void xanbEXT (int id, float* in, float* out);
...
extern __declspec (dllexport) void pSetRCVRANBTau (ANB a, float tau);

extern __declspec (dllexport) void pSetRCVRANBHangtime (ANB a, float time);

extern __declspec (dllexport) void pSetRCVRANBAdvtime (ANB a, float time);

extern __declspec (dllexport) void pSetRCVRANBBacktau (ANB a, float tau);

extern __declspec (dllexport) void pSetRCVRANBThreshold (ANB a, float thresh);
