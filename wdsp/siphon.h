...
extern SIPHON create_siphon (int run, int insize, float* in, int sipsize, int fftsize, int specmode);
...
extern __declspec (dllexport) void xsiphonEXT (int id, float* buff);
