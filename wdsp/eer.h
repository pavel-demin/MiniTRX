...
__declspec (dllexport) EER create_eer (int run, int size, float* in, float* out, float* outM, int rate, float mgain, float pgain, int rundelays, float mdelay, float pdelay, int amiq);
...
__declspec (dllexport) void pSetEERMgain (EER a, float gain);

__declspec (dllexport) void pSetEERPgain (EER a, float gain);

__declspec (dllexport) void pSetEERRunDelays (EER a, int run);

__declspec (dllexport) void pSetEERMdelay (EER a, float delay);

__declspec (dllexport) void pSetEERPdelay (EER a, float delay);
