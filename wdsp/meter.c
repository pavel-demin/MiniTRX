...
METER create_meter (int run, int* prun, int size, float* buff, int rate, float tau_av, float tau_decay, float* result, CRITICAL_SECTION** pmtupdate, int enum_av, int enum_pk, int enum_gain, float* pgain)
{
