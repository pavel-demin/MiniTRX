...
extern float* eq_mults (int size, int nfreqs, float* F, float* G, float samplerate, float scale, int ctfmode, int method);

extern EQ create_eq (int run, int size, float *in, float *out, int nfreqs, float* F, float* G, int ctfmode, int method, int samplerate);
...
extern __declspec (dllexport) void SetRXAEQProfile (int channel, int nfreqs, float* F, float* G);
...
extern __declspec (dllexport) void SetTXAEQProfile (int channel, int nfreqs, float* F, float* G);
