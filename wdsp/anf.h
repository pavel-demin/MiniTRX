...
extern __declspec (dllexport) void SetRXAANFVals (int channel, int taps, int delay, float gain, float leakage);
...
extern __declspec (dllexport) void SetRXAANFGain (int channel, float gain);

extern __declspec (dllexport) void SetRXAANFLeakage (int channel, float leakage);
