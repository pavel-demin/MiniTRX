...
extern  void SetRXAAMSQThreshold (int channel, float threshold);

extern  void SetRXAAMSQMaxTail (int channel, float tail);

// TXA Properties

extern  void SetTXAAMSQRun (int channel, int run);

extern  void SetTXAAMSQMutedGain (int channel, float dBlevel);

extern  void SetTXAAMSQThreshold (int channel, float threshold);
