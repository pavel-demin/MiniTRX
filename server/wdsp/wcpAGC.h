...
extern void SetRXAAGCFixed (int channel, float fixed_agc);
...
extern void GetRXAAGCHangLevel(int channel, float *hangLevel);

extern void SetRXAAGCHangLevel(int channel, float hangLevel);
...
extern void GetRXAAGCTop(int channel, float *max_agc);

extern void SetRXAAGCTop (int channel, float max_agc);

extern void SetRXAAGCSlope (int channel, int slope);

extern void SetRXAAGCThresh(int channel, float thresh, float size, float rate);

extern void GetRXAAGCThresh(int channel, float *thresh, float size, float rate);
...
extern void SetTXALevelerTop (int channel, float maxgain);
