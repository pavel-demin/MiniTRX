...
void MiniTRX::on_IndicatorRX_changed(int freq)
{
...
void MiniTRX::on_FrequencyRX_changed(int freq)
{
...
void MiniTRX::on_IndicatorFFT_changed(int freq)
{
...
void MiniTRX::on_Range_changed(int range)
{
  int step = 10;
...
void MiniTRX::on_Offset_changed(int offset)
{
  int step = 10;
  switch(fRange->value())
  {
